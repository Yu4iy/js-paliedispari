...
btn.addEventListener('click', function(){
	let parDis = document.querySelector('.input__pari-dispari').value.toLowerCase().trim()
	...
	if(((parDis !== 'pari') && (parDis !== 'dispari')) || (userNumber > 5 || userNumber < 0 || isNaN(userNumber))){
	alert('INSERIRE DATI CORETTI')
	}else{
